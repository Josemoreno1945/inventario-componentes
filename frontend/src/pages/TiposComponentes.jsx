...
export default function TiposComponentes() {
    ...
    const fetchTipos = async () => {
        try {
            const response = await fetch(`${API_BASE_URL}/api/tipos-componentes`);
    ...
    const handleEdit = async (id) => {
        try {
            const response = await fetch(`${API_BASE_URL}/api/tipos-componentes/${id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const url = editingId 
                ? `${API_BASE_URL}/api/tipos-componentes/${editingId}`
                : `${API_BASE_URL}/api/tipos-componentes`;
